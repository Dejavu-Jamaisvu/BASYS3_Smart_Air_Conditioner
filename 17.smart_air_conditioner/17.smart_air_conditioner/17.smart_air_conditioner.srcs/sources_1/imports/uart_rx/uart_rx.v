...
module uart_rx #(
    ...
    // 9600 * 16 = 153,600
    // 100_000_000 Hz / 153_000 = 651ns ( 651ns주기로 sampling )
    parameter integer DIVIDER_CNT = 100_000_000 / (BPS * 16);
    
    reg [1:0] r_state;  // state S_IDLE --> S_STOP_BIT
    reg [3:0] r_bit_cnt;   // r_data_reg에 저장할 index값
    reg [7:0] r_data_reg;   // rx 포트로 부터 들어온 bit를 담을 그릇 
    reg [15:0] r_baud_cnt;   // 651ns : 9600bps * 16(sapmpling 구간) count변수 
